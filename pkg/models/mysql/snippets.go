...
// Define a SnippetModel which wraps a sql.DB connection pool.
...
func (m *SnippetModel) Insert(title, content, expires string) (int, error) {
	...
	// newly insertd record in the snippets table.
...
func (m *SnippetModel) Get(id int) (*models.Snippet, error) {
	...
	// If everything went Ok then return Snippet object.
	return s, nil
}
...
func (m *SnippetModel) Latest() ([]*models.Snippet, error) {
	...
	// result set automatically closes itself and free up the underlying
	// database connection
	for rows.Next() {
		...
		// must be pointers to the place you want to copy the data into, and then
