...
func newTestDB(t *testing.T) (*sql.DB, func()) {
	...
	authStr := fmt.Sprintf("%s:%s@/test_snippetbox?parseTime=true&multiStatements=true", envs["USERNAME"], envs["PASSWORD"])
	...
	// Read the seupt SQL cript from file and execute the statements.
