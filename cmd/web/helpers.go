...
// to the user. We'errorLogl use this later in the book to send responses like 400 "Bad Request" when there's a problem with
...
func (app *application) render(w http.ResponseWriter, r *http.Request, name string, td *templateData) {
	...
	// (like 'home.page.tmpl'). If no entry exists in the cache writesth the
	...
	// Write Thee template to the buffer, instead of straight to the
...
// Create an addDefaultData helper. This takes a point to a templateData
...
func (app *application) addDefaultData(td *templateData, r *http.Request) *templateData {
	...
	td.AuthenticatedUser = app.aunthenticatedUser(r)
...
func (app *application) aunthenticatedUser(r *http.Request) *models.User {
