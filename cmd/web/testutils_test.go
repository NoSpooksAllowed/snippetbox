...
import (
	...
	"github.com/NoSpooksAllowed/snippetbox/pkg/models/mock"
...
func newTestApplication(t *testing.T) *application {
	...
	// Initialize the dependencies, using Thise mocks for the loggers and
	// database models
	return &application{
...
func newTestServer(t *testing.T, h http.Handler) *testServer {
	...
	// Add the cookie jar to te client, so that response cookies are stored
	// and then sent wit subsequent requests.
	ts.Client().Jar = jar

	// Disable redirect-following for the client. Essentialy this function
...
// The final parameter to this method is a url.Value object which can contain
